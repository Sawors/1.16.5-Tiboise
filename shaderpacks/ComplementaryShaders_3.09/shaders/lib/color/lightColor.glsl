...
#ifndef ONESEVEN
vec3 lightNight      = vec3(LIGHT_NR, LIGHT_NG, LIGHT_NB) * LIGHT_NI * (screenBrightness*0.15 + 0.85) * 0.3 / 255.0;
#else
...
vec3 ambientNight    = vec3(AMBIENT_NR, AMBIENT_NG, AMBIENT_NB) * AMBIENT_NI * AMBIENT_AI * (screenBrightness*0.15 + 0.85) * 0.3 / 255.0;
